...
# etapa 2: adicionar John Lennon, Paul McCartney e George Harrison
beatles.append("John Lennon")
beatles.append("Paul McCartney")
beatles.append("George Harrison")
print("Etapa 2:", beatles)

# etapa 3: pedir ao usuário para adicionar Stu Sutcliffe e Pete Best
for i in range(2):
    novo_membro = input("Adicione um novo membro da banda: ")
    beatles.append(novo_membro)
print("Etapa 3:", beatles)

# etapa 4: remover Stu Sutcliffe e Pete Best
del beatles[-2:]
