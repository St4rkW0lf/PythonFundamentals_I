...
#
# O código usa duas listas - uma com os dados de teste e a outra contendo os resultados esperados. 
# O código informará se algum dos resultados é inválido.


# Código
def is_year_leap(year):
    # Um ano é bissexto se for divisível por 4,
    # mas não por 100, exceto se for também divisível por 400.
    if year % 4 != 0:
        return False
    elif year % 100 != 0:
        return True
